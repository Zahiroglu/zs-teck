...
import '../../../services/local_databases_services/models/model_downloads.dart';
import '../../new_models/logged_usermodel.dart';
import '../models/model_rut_perform.dart';
...
class ControllerDashBorudExp extends GetxController {
  ...
  RxList<UserPermitionsModel> listPermitions=List<UserPermitionsModel>.empty(growable: true).obs;
  ...
  initializeBazalar() async {
   ...
   // await localGirisCixisServiz.init();
    ...
    listPermitions.value = loggedUserModel
        .userModel!.permitions!
        .where((element) => element.isMenuItems == true)
        .toList();
    getInfoAboudEnter();
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          CustomText(
                            labeltext:
                                "${loggedUserModel.userModel!.userName!} ${loggedUserModel.userModel!.userSurname!}",
                            fontsize: 18,
                            color: Colors.black,
                          ...
                          CustomText(
                            labeltext:
                                "${loggedUserModel.userModel!.moduleName!} | ${loggedUserModel.userModel!.roleName!} | ${loggedUserModel.userModel!.temKod!}",
                            fontsize: 14,
                            color: Colors.black,
                            fontWeight: FontWeight.normal,
                          )
                    ...
                    children: [
                      Padding(
                        ...
                        child: CustomText(
                            ...
                            fontsize: 18,
                            labeltext:
                                "Menular ( ${loggedUserModel.userModel!.permitions!.where((element) => element.isMenuItems ==true).toList().length} )"),
                      )
                    ],
                  ),
                  const SizedBox(
  ...
  Widget widgetItemsForMenular(UserPermitionsModel model) {
    int indexitem = loggedUserModel.userModel!.permitions!.indexOf(model);
    return Padding(
      padding: const EdgeInsets.all(5.0),
      child: Column(
        mainAxisAlignment: MainAxisAlignment.start,
